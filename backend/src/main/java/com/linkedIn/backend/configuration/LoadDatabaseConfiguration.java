...
public class LoadDatabaseConfiguration {
    ...
    private List<AuthenticationUser> createUsers(AuthenticaltionUserRepository authenticaltionUserRepository) {
...
//                }
    ...
    private HashSet<AuthenticationUser> generateLikes(List<AuthenticationUser> users, Random random) {
        ...
        int maxLikes = Math.min(50, users.size() / 10); // Maximum 50 likes or 10% of usersMore actions
